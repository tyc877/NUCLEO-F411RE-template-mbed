...
CC_FLAGS += -MMD -MP
CC_SYMBOLS = -DTARGET_NUCLEO_F411RE -DTARGET_M4 -DTARGET_CORTEX_M -DTARGET_STM -DTARGET_STM32F4 -DTARGET_STM32F411RE -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -D__CORTEX_M4 -DARM_MATH_CM4 -D__FPU_PRESENT=1 -DMBED_BUILD_TIMESTAMP=1425134237.86 -D__MBED__=1 -DTARGET_FF_ARDUINO -DTARGET_FF_MORPHO 
